...
<div>
	...
	<div class="search_member_info clearfix">
		<form
			...
			<input type="hidden" id="my_url" name="my_url" value="delete" />
		...
		<form
			...
			<div class="input_area">
				<div class="colum clearfix">
					...
					<p class="float_l ml_15">
						姓<input type="text" name="last_name"
							value="<%=m_i.getLast_name()%>" disabled>
					</p>
					<p class="float_l ml_15">
						名<input type="text" name="first_name"
							value="<%=m_i.getFirst_name()%>" disabled>
					</p>
				</div>
				<div class="colum clearfix">
					<p>■性別</p>
					<p class="float_l ml_15" >
						<input type="radio" name="sex" value="1" disabled <%if (m_i.getSex() == 1) {%>
							checked <%}%>>男
					</p>
					<p class="float_l ml_15">
						<input type="radio" name="sex" value="2" disabled<%if (m_i.getSex() == 0) {%>
							checked <%}%>>女
					</p>
				</div>
								<div class="colum clearfix">
				...
				<div class="colum clearfix">
					...
					<p class="ml_15">
						<input type="tel" name="phone_number" style="width: 200px;"
							maxlength="15" value="<%=m_i.getPhone_number()%>" disabled>
					</p>
				</div>
				<div class="colum">
					<p>■メールアドレス</p>
					<p class="ml_15">
						<input type="email" name="mail_address" style="width: 200px;"
							maxlength="50" value="<%=m_i.getMail_address()%>" disabled>
					</p>
				</div>
				...
				<div class="colum clearfix">
					<p>■職業</p>
					<p class="ml_15">
						<select name="job" style="width: 200px;" disabled>
			...
			<input type="hidden" id="post_type" name="post_type" value="Delete" />
	</div>
